...
// module configs
$cfg = loadConfigurations('usercp.buyzen');
...
// config file data
$maxZen = $cfg['max_zen'];
$exchangeRatio = $cfg['exchange_ratio'];
$incrementRate = $cfg['increment_rate'];
...
// form submit
if(check($_POST['submit'], $_POST['character'], $_POST['credits'])) {
	try {
